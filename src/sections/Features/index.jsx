    ...
    <div className="mx-auto px-32 space-y-8">
      <div className="space-y-2">
        <h2 className="text-3xl font-bold text-center">
          ...
          <span className="text-red">efficiency</span>
        </h2>
      ...
      <div className="flex gap-4">
        <Card>
          ...
          <ul className="max-w-md space-y-1 text-green list-disc list-inside mt-3">
      ...
      <div className="flex gap-4 justify-evenly mt-7 relative">
        <Card className="flex flex-col gap-2 h-72">
          ...
          <div className="bg-red p-3 w-20 h-20 flex justify-center items-center rounded-xl absolute bottom-2">
