...
const DevelopBusiness = () => {
  return (
    <div className="flex px-32 gap-14">
      <div className="flex flex-col gap-10  w-1/2">
        <Card className="flex gap-2 justify-between items-center bg-light">
          <div className="">
            <p className="text-xl font-semibold">E-commerce platform</p>
            <p className="text-xl font-semibold">E-commerce platform</p>
          </div>
          <img
        ...
        <Card className="flex gap-2 justify-between items-center bg-green">
          <div className="">
            <p className="text-xl font-semibold">E-commerce platform</p>
            <p className="text-xl font-semibold">E-commerce platform</p>
          </div>
        ...
        <Card className="flex gap-2 justify-between items-center bg-secondary">
          <div className="">
            <p className="text-xl font-semibold">E-commerce platform</p>
            <p className="text-xl font-semibold">E-commerce platform</p>
          </div>
